...
public class Const {
    public static final String AuthenticationKey     = "YzBhODc0YmExODI3MjI3ZjQ2NjczMmIyNmMxNTE0OTM3ZjA3MTQ1MDk5YTIzNTkxMTgzZmEyMjcwYzQ1MzA1Yw==";
    public static final String URL_BLOG_CATEGORIES   = "http://www.torbjornzetterlund.com/bp4a-api/v1/categories/";
    public static final String URL_RECENTLY_ADDED    = "http://www.torbjornzetterlund.com/api/latest/";
//    public static final String URL_RECENTLY_ADDED    = "http://www.torbjornzetterlund.com/api/get_recent_posts/";
    public static final String URL_CATEGORY_POST	 = "http://www.torbjornzetterlund.com/bp4a-api/v1/category/_CAT_ID_/";
    public static final String URL_STORY_PAGE	 	 = "http://www.torbjornzetterlund.com/bp4a-api/v1/post/_STORY_ID_/";
    public static final String URL_SEARCH_RESULT	 = "http://www.torbjornzetterlund.com/bp4a-api/v1/search/_SEARCH_KEYWORD_/_PAGE_NO_";
    public static final String URL_COMMENTS_PAGE	    = "http://www.torbjornzetterlund.com/bp4a-api/v1/post_comment/_STORY_ID_/";
    public static final String URL_COMMENTS_LIST_PAGE   = "http://www.torbjornzetterlund.com/bp4a-api/v1/comments/_STORY_ID_/_PAGE_NO_";
